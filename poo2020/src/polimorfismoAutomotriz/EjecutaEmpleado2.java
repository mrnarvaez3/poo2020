    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (opcion == 1) {
                ...
                EmpAdmin2 empAdmin2 = new EmpAdmin2(sueldoMensual, nombre, departamento, puesto);
                empAdmin2.calcularQuincena();
                cadena = String.format("%s%d%20s%20s%20s%20.2f\n", cadena, contador, nombre, departamento, puesto, empAdmin2.getQuincena());
            } else {
                if (opcion == 2) {
                    System.out.println("Ingrese el nombre del empleado:");
                    nombre = teclado.nextLine();
                    ...
                    EmpMecan2 empMecan2 = new EmpMecan2(precioTrabajo, nombre, departamento, puesto);
                    empMecan2.calcularQuincena();
                    cadena = String.format("%s%d%20s%20s%20s%20.2f\n", cadena, contador, nombre, departamento, puesto, empMecan2.getQuincena());
                } else {
                    System.out.println("Ingrese el nombre del empleado:");
                    nombre = teclado.nextLine();
                    System.out.println("Ingrese el departamento del empleado: ");
                    ...
                    EmpVendedor2 empVendedor2 = new EmpVendedor2(ventas, nombre, departamento, puesto);
                    empVendedor2.calcularQuincena();
                    cadena = String.format("%s%d%20s%20s%20s%20.2f\n", cadena, contador, nombre, departamento, puesto, empVendedor2.getQuincena());
                }
            }
